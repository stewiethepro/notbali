                  ...
                  >
                    ...
                    >
                      <div
                        ...
                        } origin-top bg-neutral-500 transition-all ease-linear dark:bg-trackpurple-600`}
                        style={{
                          transitionDuration:
                            currentIndex === index
                              ? `${collapseDelay}ms`
                    ...
                    <AccordionTrigger className={`text-xl font-bold ${currentIndex === index ? 'text-trackpurple-300' : ""}`}>
                      {item.title}
                    </AccordionTrigger>
